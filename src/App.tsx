...
export default function App(){
  ...
  return <>
    ...
    <main>
      <section className="hero" id="home"><div className="heroMeta"><span>FRONTEND / FULL STACK</span><span>SEOUL, KR · 2026</span></div><div className="heroTitle"><p>실시간 데이터와</p><h1>상태 관리를<br/><em>설계하는</em> 개발자</h1></div><div className="heroFoot"><p>React와 TypeScript 기반의 프론트엔드부터<br/>Java·Spring 백엔드까지, 제품의 전체 흐름을 만듭니다.</p><a href="#about" className="scroll"><ArrowDown/>SCROLL TO EXPLORE</a></div><div className="orb"/></section>
